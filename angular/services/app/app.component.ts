...
//   }
  ...
  world = 'world';
//mytodollist
  mytodolistArr = JSON.parse(localStorage.getItem('mytodolistArr'));
  mytodolistArred = JSON.parse(localStorage.getItem('mytodolistArred'));
  //input到进行队列
  // pushArr(val){
  //   this.mytodolistArr.push(val);
  //   // this.mytodolistArr = this.localGet('mytodolistArr');
  // }
  // //进行队列删除
  // pushArred(val){
